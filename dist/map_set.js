...
var meuMap = new Map(); /*Criando*/
meuMap.set("nome", "gian"); /*("Chave", "ValorDaChave")*/
meuMap.set("stack", "HTML, css, js");
console.log(meuMap);
var nome = meuMap.get("nome"); /*Pegando o valor de uma chave*/
console.log(nome);
...
cpfs.forEach(function (item) {
  console.log("O CPF \xE9: ".concat(item));
});
var array = ["Gian", "Matheus", "Juliana", "Pedro", "Gian", "Pedro"]; /*Retirando repetições de um array*/
var arrayComoSet = new Set([].concat(array));
console.log(arrayComoSet);
var arraySemItensDuplicados = _toConsumableArray(arrayComoSet); /*Fazendo voltar a ser array*/
